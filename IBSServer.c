...
JNIEXPORT jstring JNICALL Java_IBSServer_GetID(JNIEnv *env, jobject obj)
{
	char temp[256] = { 0, };
...
JNIEXPORT jstring JNICALL Java_IBSServer_GetRand(JNIEnv *env, jobject obj)
{
	BIGNUM *rand = BN_new();
...
JNIEXPORT jstring JNICALL Java_IBSServer_Sign(JNIEnv *env, jobject obj, jstring msg, jint msglen)
{
...
JNIEXPORT jboolean JNICALL Java_IBSServer_Verify(JNIEnv *env, jobject obj, jstring msg, jint msglen, jstring chal, jint challen)
{
