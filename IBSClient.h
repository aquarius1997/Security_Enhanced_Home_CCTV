 ...
 */
 ...
 JNIEXPORT jstring JNICALL Java_IBSClient_GetIV
  (JNIEnv *, jobject);
...
JNIEXPORT jstring JNICALL Java_IBSClient_getGMod(JNIEnv *, jobject , jstring);
JNIEXPORT jstring JNICALL Java_IBSClient_getBaseExp(JNIEnv *, jobject , jstring, jstring);
