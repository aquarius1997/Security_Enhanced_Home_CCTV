...
public class IBSClient {
	...
	for(;;){
		try {
				...
				String cmd = "raspivid -t 0 -h 480 -w 640 -fps 15 -b 200000 -o -  | gst-launch-1.0 fdsrc ! h264parse ! rtph264pay config-interval=1 pt=96 ! 'application/x-rtp, payload=(int)96, ssrc=(uint)3412089386' ! srtpenc key=\""+ GstreamerKey  +"\" ! udpsink host=172.30.1.1 port=5004";
